use crate::DefStruct;
use crate::def::{
    enums::PSwitchTriggerType, values::EngineGraphic, values::ThingComponentSet, wire::DefIndex,
    wire::DefString,
};
...
pub struct ThingPhysicalSwitchDef {
    ...
    #[def("PersistenceFlags", default = 1)] // EPF_STATIC (retail NULLDEF default)
    pub persistence_flags: i32,
    #[def("Health")]
    pub health: f32,
    ...
    #[def("TriggerType")]
    pub trigger_type: PSwitchTriggerType,
    #[def("UntriggeredGraphic")]
    pub untriggered_graphic: EngineGraphic,
    #[def("TriggeredGraphic")]
    pub triggered_graphic: EngineGraphic,
    #[def("TriggerSound")]
    pub trigger_sound: i32,
}
